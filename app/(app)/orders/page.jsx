  ...
  return (
    <div className="page-stack animate-fade-in">
      ...
      <form className="section-card filter-bar" method="get" action="/orders">
        ...
        <div className="filter-group">
          <label className="filter-label" htmlFor="payment">Pembayaran</label>
          <select id="payment" name="payment" defaultValue={paymentFilter} className="glass-input px-3 py-2">
